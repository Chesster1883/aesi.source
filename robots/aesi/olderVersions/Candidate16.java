...
public class Candidate16 extends AdvancedRobot
{
...
setTurnGunLeft((((79 * 74) - (enemyBearing - 66)) / ((getGunTurnRemainingRadians() / getHeadingRadians()) - (45 + bulletBearing))));
}
...
setTurnGunRight(((((getHeadingRadians() - 72) / (79 * 75)) / ((54 - enemyBearing) - getRadarTurnRemainingRadians())) / (((getHeadingRadians() - getRadarHeadingRadians()) + getDistanceRemaining()) - ((wallBearing - 83) + 50))));
setTurnLeft(47);
}
...
setMaxTurnRate(((83 * wallBearing) + (55 - 80)));
}
