...
public class Candidate24 extends AdvancedRobot
{
...
setMaxTurnRate((((((enemyDistance / 58) * getGunTurnRemainingRadians()) + ((95 - 41) - 35)) + (((68 / enemyHeading) * enemyHeading) * (enemyDistance + 39))) - ((((97 / 74) - enemyDistance) * (getTurnRemainingRadians() + enemyEnergy)) / (((24 / 90) / wallBearing) / (bulletBearing * 83)))));
}
...
setTurnGunRight((((((enemyEnergy * enemyHeading) - 72) / ((enemyEnergy - enemyHeading) * 1)) / (((16 * enemyDistance) - enemyBearing) - (enemyEnergy * bulletHeading))) - ((((25 / getHeadingRadians()) - getHeadingRadians()) + (getGunHeadingRadians() + enemyEnergy)) - (((getGunHeadingRadians() / bulletBearing) - 83) + (61 * getRadarTurnRemainingRadians())))));
}
