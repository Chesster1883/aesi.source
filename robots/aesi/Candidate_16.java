...
setTurnGunLeft((getGunTurnRemainingRadians() / getRadarHeadingRadians()));
}
...
setAhead(((getDistanceRemaining() - getRadarHeadingRadians()) - (91 / 17)));
setFire(41);
...
setTurnRadarLeft(getDistanceRemaining());
}
